...
export class AsignacionConductorService {
  ...
  async verificarConductorCerca(parada: any, conductorId: any): Promise<boolean> {
  ...
  async enviarNotificacionYEsperarRespuesta(conductorId: any): Promise<RespuestaConductor> {
